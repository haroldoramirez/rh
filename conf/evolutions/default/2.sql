...
insert into cargo (nome,data_cadastro,data_alteracao) values ('Analista de Sistemas','now','now');
insert into cargo (nome,data_cadastro,data_alteracao) values ('Gestor','now','now');
insert into cargo (nome,data_cadastro,data_alteracao) values ('Analista de Comunicação','now','now');
insert into cargo (nome,data_cadastro,data_alteracao) values ('Diretor Técnico','now','now');

insert into area (nome,nome_gerente,data_cadastro,data_alteracao) values ('Núcleo Pedagógico','Marcelo','now','now');
insert into area (nome,nome_gerente,data_cadastro,data_alteracao) values ('Laboratório','Rafael','now','now');

insert into escolaridade (nome,data_cadastro,data_alteracao) values ('Ensino Médio Completo','now','now');
insert into escolaridade (nome,data_cadastro,data_alteracao) values ('Ensino Técnico','now','now');
insert into escolaridade (nome,data_cadastro,data_alteracao) values ('Graduação (Bacharelado)','now','now');
insert into escolaridade (nome,data_cadastro,data_alteracao) values ('Graduação (Licenciatura)','now','now');
insert into escolaridade (nome,data_cadastro,data_alteracao) values ('Especialização (Lato Sensu)','now','now');
insert into escolaridade (nome,data_cadastro,data_alteracao) values ('Mestrado (Stricto Sensu)','now','now');
insert into escolaridade (nome,data_cadastro,data_alteracao) values ('Doutorado (Stricto Sensu)','now','now');
